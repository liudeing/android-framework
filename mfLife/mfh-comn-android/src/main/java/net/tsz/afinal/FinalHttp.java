            ...
            public void process(HttpRequest request, HttpContext context) {
                ...
                for (String header : clientHeaderMap.keySet()) {
                    if(request.containsHeader(header)){
                        request.setHeader(header, clientHeaderMap.get(header));
                    }
                    else{
...
//                    MLog.d("FinalHttp.request.cookie:" + cookie.toString());
//                }
...
//                }
        ...
        httpClient.addResponseInterceptor(new HttpResponseInterceptor() {
            public void process(HttpResponse response, HttpContext context) {
                ...
                for (Cookie cookie : httpClient.getCookieStore().getCookies()){
                    MLog.d("FinalHttp.response.cookie:" + cookie.toString());
                }
            }
        });
//        httpClient.getParams().setParameter(ClientPNames.COOKIE_POLICY, CookiePolicy.IGNORE_COOKIES);
        ...
        configRequestExecutionRetryCount(maxRetries);
    ...
    */
    ...
    public void post(String url, AjaxParams params, AjaxCallBack<? extends Object> callBack) {
        MLog.d(String.format("[POST]%s?%s", url, params.toString()));
