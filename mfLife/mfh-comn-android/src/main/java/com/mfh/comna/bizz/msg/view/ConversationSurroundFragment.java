 ...
 */
public class ConversationSurroundFragment extends BaseListFragment<EmbSession> {
    ...
    public ConversationSurroundFragment() {
        super();
    ...
    public int getLayoutId() {
        return R.layout.fragment_conversation_surround;
    }
    ...
    private void registerReceiver() {
        ...
        receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                MLog.d(String.format("ConversationSurroundFragment.onReceive.action= %s", action));
