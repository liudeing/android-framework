...
package com.mfh.comna.utils.qrcode.camera;
...
final class FlashlightManager {
  ...
  static {
    ...
    if (iHardwareService == null) {
      MLog.v(TAG, "This device does supports control of a flashlight");
    } else {
      MLog.v(TAG, "This device does not support control of a flashlight");
    }
  }
